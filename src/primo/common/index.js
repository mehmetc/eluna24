...
export default class Common {
  ...
  static isFullView() {
    try {
      return this.components.controller("prm-full-view-page") == null
        ? false
        : true;
    } catch (e) {
      return false;
  ...
  static isFullViewOverlay() {
    try {
      return this.components.controller("prm-full-view") &&
        !this.components.controller("prm-full-view-page")
        ? true
        : false;
    } catch (e) {
      return false;
  ...
  /**
   * returns a list of base urls used in services
   *
   * @returns object
   */
